...
private:
    ...
    AP_Float _xPosNoise;            // X - pos estimate error. Used in external navigation.
    AP_Float _yPosNoise;            // Y - pos estimate error. Used in external navigation.
    AP_Float _zPosNoise;            // Z - pos estimate error. Used in external navigation.
    AP_Int16  _extNavDelay_ms;      // effective average delay of external measurements rel to IMU (msec)
