...
const AP_Param::GroupInfo NavEKF2::var_info[] = {
    ...
    AP_GROUPINFO("X_P_NSE", 50, NavEKF2, _xPosNoise, 0.1f),

    AP_GROUPINFO("Y_P_NSE", 51, NavEKF2, _yPosNoise, 0.1f),

    AP_GROUPINFO("Z_P_NSE", 52, NavEKF2, _zPosNoise, 0.1f),

    AP_GROUPINFO("EXT_DELAY", 53, NavEKF2, _extNavDelay_ms, 0),
